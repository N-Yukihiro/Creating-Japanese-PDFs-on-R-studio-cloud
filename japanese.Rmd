--- 
title: "R studio cloudで日本語PDFを作成する"
...
# R studio cloudで日本語PDFを作成する

R studio cloud (Rstudio.cloud) はブラウザ上でR studioを利用できる優れたサービスです．
しかし，デフォルトのままでは日本語を含むPDFを作成することが困難です．
日本語を含むPDFを作成する方法がインターネット上になかったのでまとめました．

R studio cloudで日本語を含むPDFを作成するには，下記のようにコードを走らせます．
...
フォントをipaexなどに変えようとしてもエラーが出てしまうので，わかる方は教えて下さい．
